#'---
#' title: "OUTRIDER Summary: `r paste(snakemake@wildcards$tissue, sep = '--')`"
#' author: mumichae, vyepez, raquel
#' wb:
#'  log:
#'   - snakemake: '/s/project/first_last_exon/Data/log/{tissue}/StrandDiff/OUTRIDER_summary_PCA.Rds'
#'  params:
...
#'              "/{tissue}_Summary.html"`'
#'   - res_html: '`sm config["htmlOutputPath"] + 
#'              "/{tissue}_OUTRIDER_results.tsv"`'
#'  type: noindex
#'  threads: 1
#'  resources:
#'   - mem_mb: 8000
...
# used for most plots
tissue_title <- paste("Dataset:", paste(snakemake@wildcards$tissue, sep = '--'))
